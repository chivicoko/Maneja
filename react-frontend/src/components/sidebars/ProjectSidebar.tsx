...
const ProjectSidebar: React.FC<SidebarProps> = ({ closeSidebar = () => {} }) => {
  ...
  // Get the Current Project
    ...
    <div className="w-full flex flex-col justify-start items-center transition-transform duration-200">
        ...
        <div className="w-full flex flex-col justify-center items-center gap-8 lg:gap-12 pb-6 lg:py-6">
            ...
            <div className='w-full px-3 flex flex-col justify-center items-center gap-1 transition-all duration-200'>
