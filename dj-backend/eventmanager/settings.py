...
SECRET_KEY = 'django-insecure-0=lof0w9$za8hytk*ohrrr2!pou6+ehugy9gd()#3&#(j_7d#1'
...
INSTALLED_APPS = [
    ...
    'recurring_tasks.apps.RecurringTasksConfig',
...
# - configuring JWT settings for expiration times, etc.
SIMPLE_JWT = {
